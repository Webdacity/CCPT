...
export default function ServiceBlock(props) {
    ...
    const Image = (props) => {
        ...
        switch (props.data.image) {
            case "hvac":
                return <Img fluid={data.hvac.childImageSharp.fluid} />
            case "consulting":
                return <Img fluid={data.consulting.childImageSharp.fluid} />
            case "system-integration":
                return <Img fluid={data.systemIntegration.childImageSharp.fluid} />
            case "maintenance":
                return <Img fluid={data.maintenance.childImageSharp.fluid} />
            case "panel-building":
                return <Img fluid={data.panelBuilding.childImageSharp.fluid} />
            default:
                return <Img />
        }
    }
    ...
    return (
        <div className={styles.block}>
            <div className={styles.image}>
                ...
                {/* <Img fluid={data.imgOne.childImageSharp.fluid} /> */}
